...
Address for Matrix
   b31                             b0    [ C B A ]
 --------------------------------------
|here W@ + 0    Y=0       here W@ + 127| [ 0 0 0 ]
|      .                          .    |    ...
|      .                          .    |    ...
|here W@ + 896    Y=7    here W@ + 1023 [ 1 1 1 ]
|--------------------------------------|
|here W@ + 1024   Y=8    here W@ + 2303| [ 0 0 0 ]
|      .                       .       |    ...
|      .                       .       |    ...
|here W@ + 3840   Y=15   here W@ + 4095| [ 1 1 1 ]
 --------------------------------------
...
\ Shift upper section(8x32) of matrix_array(16x32) to left(1dot)
