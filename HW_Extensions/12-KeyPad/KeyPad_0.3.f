...
8 wconstant KeyPad
7 KeyPad lshift constant mKeyPad
...
wvariable swState        \ current input-data
wvariable lastswState    \ last input-data
wvariable debounce
wvariable char     
variable buffer 
wvariable pointer  
...
begin
     ...
     mKeyPad ina COG@ and KeyPad rshift      \ 3bit-data(Row[1..3]) 
     dup lastswState W@ <>                      
     if
