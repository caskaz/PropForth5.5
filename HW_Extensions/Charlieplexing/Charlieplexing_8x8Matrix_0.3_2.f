...
z2WyPW8 l, z2WiPfh l, z2WiPmB l, z2Wyxj0 l, z2WyxW0 l, z1Sy\Sb l, z2WixZD l, z2Wyxmy l,
z2WiPvf l, z20iPyk l, z3ryPr0 l, ziPuE l, z2[iQ3F l, z24yQ01 l, z2WixZG l, z2WixmF l,
z1Sy\Sb l, zfyPb1 l, z20yPj1 l, z3[yP[M l, z1SV04J l, z2WiPvg l, z20iPyk l, z3ryPr0 l,
z1SV000 l, z38 l, zJY0 l, z1 l,
freedict
...
begin
     ...
     8 0 do
          ...
          i lshift outa COG!
          hFF dira COG!
          \ Set data (L-active for outa register)
          matrix i + C@ dup 
          invert outa COG!              \ Set inverted data to outa register 
          dira COG!                     \ Set data to dira register
...
__2     
	...
	add       $C_treg4 , cnt
     ...
     \ Set inverted data to outa register
     rdbyte    $C_treg4 , $C_treg3
     neg       $C_treg5 , $C_treg4
     sub       $C_treg5 , # 1
     mov       outa , $C_treg5
     \ Deactivate other SCRs
     mov       dira , $C_treg4
