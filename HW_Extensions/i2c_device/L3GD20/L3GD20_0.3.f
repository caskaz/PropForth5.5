...
3-axis Gyroscope module (L3GD20)
...
\ ( -- )
: test WHO_AM_I L3GD20 i2c_rd hex . decimal cr ;
...
: FIFO_mode
5 lshift
fifo_ctrl L3GD20 i2c_rd            \ Read FIFO_CTRL register 
h1F and or                    
fifo_ctrl L3GD20 i2c_wr            \ Write data to FIFO_CTRL register 
;
...
: dps
4 lshift
ctrl4 L3GD20 i2c_rd                \ Read CTRL_REG4 register 
hCF and or
ctrl4 L3GD20 i2c_wr                \ Write data to CTRL_REG4 register 
;
...
: dataReady?
begin
     status L3GD20 i2c_rd          \ Read status register 
     8 and 0=                      \ Check bit3
     if 0 else 1 then
until
;
...
: show_xyz
\ init L3GD20
8 ctrl3 L3GD20 i2c_wr            
h80 ctrl4 L3GD20 i2c_wr
h1F ctrl1 L3GD20 i2c_wr  
...
0
begin
     temp L3GD20 i2c_rd dup h80 and
     if invert 1+ h2D emit then    \ Print "-" if minus
     .                             \ Display Temperature
     dataReady?
     get_xyz
{     
