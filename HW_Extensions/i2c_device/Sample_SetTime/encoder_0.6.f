...
{
Measuring time from P2-Lo to P2-Hi --> 105usec(3.03kHz) --> 9523count/sec
Using encoder 24P/R --> 96count/R 

rotation speed =9523/96=99R/sec
encoder(without click) can use until 99rotation/second
